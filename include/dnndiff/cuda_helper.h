...
void helperSetTensorDescriptor(const dnndiff::Tensor& tensor,
                               cudnnTensorDescriptor_t tensorDesc);

void helperSetBroadcastableTensorDescriptor(const dnndiff::Tensor& input,
                                            const dnndiff::Tensor& output,
                                            cudnnTensorDescriptor_t tensorDesc);
...
cudnnActivationMode_t get_activation_mode(dnndiff::ActiMode activation);
#endif
